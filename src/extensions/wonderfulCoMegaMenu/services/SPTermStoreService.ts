...
// import { IMegaNav, ITopNav, INavItem } from '.';
...
//   public async getMegaNavAsync(topTermSet: string, bottomTermSet: string, language: number): Promise<IMegaNav> {
//     //console.log("Getting meganav async", topTermSet, bottomTermSet, language);
//     const topMenuItems = await this.getTermsFromTermSetAsync(topTermSet, language);

//     //console.log("Top Menu Items", topMenuItems);
//     const megaNav: IMegaNav = {
//       globalNav: [],
//       // topNav: [],
//       footer: []
//     };
...
//     //Get the top nav
//     topMenuItems.forEach((term: ISPTermObject) => {
//       if (term.name === "MainNav") {
//         const navItems: INavItem[] = term.terms.map((navNode: ISPTermObject) => {
//           const navItem: INavItem = {
//             name: navNode.name,
//             url: navNode.localCustomProperties["_Sys_Nav_SimpleLinkUrl"],
//             imageUrl: navNode.localCustomProperties["imageurl"],
//             width: navNode.localCustomProperties["width"],
//             height: navNode.localCustomProperties["height"],
//             dataInterception: navNode.localCustomProperties["data-interception"]
//           };

//           return navItem;
//         });

//         megaNav.globalNav = navItems;
//       } else if (term.name === "SecondaryNav") {
//         megaNav.topNav = term.terms.map((navNode: ISPTermObject) => {
//           const thisNav: ITopNav = {
//             name: navNode.name,
//             navItems: []
//           };

//           thisNav.navItems = navNode.terms.map((termObj: ISPTermObject) => {
//             const navItem: INavItem = {
//               name: termObj.name,
//               url: termObj.localCustomProperties["_Sys_Nav_SimpleLinkUrl"],
//               imageUrl: termObj.localCustomProperties["imageurl"],
//               width: termObj.localCustomProperties["width"],
//               height: termObj.localCustomProperties["height"],
//               dataInterception: termObj.localCustomProperties["data-interception"]
//             };
...
//     //console.log("Getting bottom nav");
//     megaNav.footer = await this.getMegaFooterAsync(bottomTermSet, language);
//     return megaNav;
//   }

//   private async getMegaFooterAsync(bottomTermSet: string, language: number): Promise<INavItem[]> {
//     //console.log("getMegaFooterAsync", bottomTermSet, language);
//     const bottomMenuItems = await this.getTermsFromTermSetAsync(bottomTermSet, language);
//     //console.log("bottomMenuItems", bottomMenuItems);

//     const links: INavItem[] = bottomMenuItems[0].terms.map((navNode: ISPTermObject) => {
//       const navItem: INavItem = {
//         name: navNode.name,
//         url: navNode.localCustomProperties["_Sys_Nav_SimpleLinkUrl"],
//         imageUrl: navNode.localCustomProperties["imageurl"],
...
//    */
//   private async getTermsFromTermSetAsync(termSetName: string, termSetLocale: Number): Promise<ISPTermObject[]> {
//     //console.log("getTermsFromTermSetAsync", termSetName, termSetLocale);
...
//       //console.log("Getting processquery");
...
//       //console.log("Service JSONResponse", serviceJSONResponse);
